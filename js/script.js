/**
 * @author sachin Jangir <'aarjayjangir@gmail.com'>
 */
(function ($) {
    "use strict";
...
var x = setInterval(function () {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "Bless the married couple for bharati & sachin";
    }
}, 1000);
...
// sr.reveal(`.sachin`,{ delay: 300, origin: 'top' })
...
console.log('\n\n%c SAVE THE DATE: April 09, 2023!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: sachin Jangir', styles1, styles2);
